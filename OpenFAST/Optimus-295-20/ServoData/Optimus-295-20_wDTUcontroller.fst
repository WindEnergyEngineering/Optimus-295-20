...
---------------------- INPUT FILES ---------------------------------------------
"../Optimus-295-20-Monopile/Optimus-295-20-Monopile_ElastoDyn.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"../Optimus-295-20/Optimus-295-20_BeamDyn.dat"    BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../Optimus-295-20/Optimus-295-20_BeamDyn.dat"    BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"../Optimus-295-20/Optimus-295-20_BeamDyn.dat"    BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"../Optimus-295-20/Optimus-295-20_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"../Optimus-295-20/Optimus-295-20_AeroDyn15.dat"  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"Optimus-295-20-Monopile_ServoDyn_wDTUcontroller.dat"   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"../Optimus-295-20-Monopile/Optimus-295-20-Monopile_HydroDyn.dat"   HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"../Optimus-295-20-Monopile/Optimus-295-20-Monopile_SubDyn.dat"     SubFile     - Name of file containing sub-structural input parameters (quoted string)
