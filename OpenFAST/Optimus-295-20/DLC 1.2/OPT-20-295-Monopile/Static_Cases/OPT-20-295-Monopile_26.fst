...
---------------------- INPUT FILES ---------------------------------------------
"../OPT-20-295-Monopile_ElastoDyn.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"OPT-20-295-Monopile_InflowFile_26.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
