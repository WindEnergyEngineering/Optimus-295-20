...
--------------------------- Input Files ---------------------------------------- 
"OPT-20-295-Monopile_ElastoDyn_8.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"OPT-20-295-Monopile_InflowFile_step8.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
