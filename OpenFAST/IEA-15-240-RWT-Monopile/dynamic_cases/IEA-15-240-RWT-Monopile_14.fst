...
---------------------- INPUT FILES ---------------------------------------------
"IEA-15-240-RWT-Monopile_ElastoDyn_14.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-15-240-RWT_InflowFile_step14.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
